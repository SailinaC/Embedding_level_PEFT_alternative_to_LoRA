...
CHECKPOINT_PATH = "outputs/approach4_all_embeddings/final/trainable_checkpoint.pt"
...
RESULTS_JSONL = OUTPUT_DIR / "all_embeddings_results.jsonl"
RESULTS_CSV = OUTPUT_DIR / "all_embeddings_results.csv"
...
def main():
    ...
    for dataset_name in DATASETS:
        ...
        result = {
            "approach": "Approach 4: All embeddings",
