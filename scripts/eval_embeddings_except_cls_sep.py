...
CHECKPOINT_PATH = "outputs/approach7_all_embeddings_except_cls_sep/final/trainable_checkpoint.pt"
...
RESULTS_JSONL = OUTPUT_DIR / "embeddings_except_cls_sep_results.jsonl"
RESULTS_CSV = OUTPUT_DIR / "embeddings_except_cls_sep_results.csv"
...
def main():
    ...
    model.bert.embeddings.word_embeddings.weight.data.copy_(checkpoint["embedding_weight"])
    ...
    for dataset_name in DATASETS:
        ...
        result = {
            "approach": "All embeddings except CLS/SEP",
